...
- `internal/config` — loads and validates `WORKFLOW.md`, and owns the host credential filter both backends apply to an agent child environment (`ReservedSecretEnvNames`).
